...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # Group data by 'Launch Site' and sum the successes
        site_success = spacex_df[spacex_df['class'] == 1].groupby('Launch Site').size().reset_index(name='counts')
        fig = px.pie(site_success, values='counts', names='Launch Site',
